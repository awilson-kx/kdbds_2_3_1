 ...
 * </ol>
 */
//TODO: Reflect Serializable change in core product
public class c implements Serializable {
    private static final long serialVersionUID = -8028139360977507780L;
    ...
    public c(Socket sock) throws KException, IOException {
        io(sock);
        handshake(s, "", false);
    }

    void handshake(Socket sock, String usernamepassword, boolean useTLS) throws KException, IOException {
        B = new byte[2 + ns(usernamepassword)];
        J = 0;
        w(usernamepassword + "\3");
        o.write(B);
    ...
    public static class KException extends Exception {
        //TODO: Add line below to core product.
        private static final long serialVersionUID = 1354173068270851909L;
...
//object.getClass().isArray()   t(int[]) is .5 isarray is .1 lookup .05
     ...
     * deserialized. This is called automatically during a sync request via  String s,..). It can be called explicitly when
