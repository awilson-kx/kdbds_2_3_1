...
class KdbDataWriterFactory(jobid: String, schema: StructType, mode: SaveMode, optionmap: util.Map[String,String]) extends DataWriterFactory[Row] {
  override def createDataWriter(partitionId: Int, attemptNumber: Int): DataWriter[Row] = {
    new WriteTask(partitionId, attemptNumber, jobid, schema, mode, optionmap)
  }
}
